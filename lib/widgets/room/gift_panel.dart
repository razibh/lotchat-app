...
class GiftPanel extends StatefulWidget {
  ...
  const GiftPanel({
    required this.receiverId, super.key,
    this.roomId,
    this.onGiftSent,
  });
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ObjectFlagProperty<Function(GiftModel, int)?>.has('onGiftSent', onGiftSent));
  }
}
        ...
        children: <>[
          ...
          Expanded(
            child: FutureBuilder<List<GiftModel>>(
              future: _giftsFuture,
              builder: (BuildContext context, AsyncSnapshot<List<GiftModel>> snapshot) {
