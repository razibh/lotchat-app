...
class _AvatarBuilderScreenState extends State<AvatarBuilderScreen>
  ...
  final AvatarService _avatarService = ServiceLocator().get<AvatarService>();

  String _selectedCategory = 'Face';
  bool _isLoading = true;  // ← এই ভেরিয়েবল যোগ করুন
  ...
  List<AvatarItem> _faceItems = [];
  List<AvatarItem> _eyesItems = [];
  List<AvatarItem> _noseItems = [];
  List<AvatarItem> _mouthItems = [];
  List<AvatarItem> _hairItems = [];
  List<AvatarItem> _outfitItems = [];
  List<AvatarItem> _accessoryItems = [];
  List<AvatarItem> _backgroundItems = [];
  ...
  Future<void> _loadItems() async {
    await runWithLoading(() async {
      ...
      // Mock data
      _faceItems = List.generate(10, (index) => AvatarItem(
        id: 'face${index + 1}',
        name: 'Face ${index + 1}',
        category: 'Face',
      ...
      _eyesItems = List.generate(10, (index) => AvatarItem(
        id: 'eyes${index + 1}',
        name: 'Eyes ${index + 1}',
        category: 'Eyes',
      ...
      _hairItems = List.generate(15, (index) => AvatarItem(
        id: 'hair${index + 1}',
      ...
      _outfitItems = List.generate(20, (index) => AvatarItem(
        id: 'outfit${index + 1}',
        name: 'Outfit ${index + 1}',
        category: 'Outfit',
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 8),
                ..._currentAvatar.entries.map((entry) {
                  return Padding(
