...
class StoryViewer extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableProperty<Moment>('story', story));
    ...
    properties.add(ObjectFlagProperty<VoidCallback>.has('onPrevious', onPrevious));
  }
}
...
class _StoryViewerState extends State<StoryViewer> with SingleTickerProviderStateMixin {
  ...
  void _loadCurrentStory() {
    final Moment moment = widget.story[_currentIndex];
        ...
        children: <>[
          ...
          PageView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              final Moment m = widget.story[index];
          ...
          Positioned(
            ...
            right: 10,
            child: Row(
              children: widget.story.asMap().entries.map((MapEntry<int, Moment> entry) {
