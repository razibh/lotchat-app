...
class CallModel {
  ...
  CallModel({
    ...
    required this.receiverId, required this.receiverName, required this.type, required this.direction, required this.status, required this.startTime, required this.duration, required this.isVideoEnabled, this.callerAvatar,
    this.receiverAvatar,
    this.endTime,
    this.channelId,
  });
