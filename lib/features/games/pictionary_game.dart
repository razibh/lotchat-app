...
class _PictionaryGameState extends State<PictionaryGame> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<bool>('isDrawing', isDrawing));
    properties.add(ColorProperty('selectedColor', selectedColor));
    properties.add(DoubleProperty('strokeWidth', strokeWidth));
    properties.add(IterableProperty<DrawingPoint>('points', points));
    properties.add(IterableProperty<String>('words', words));
    properties.add(StringProperty('currentWord', currentWord));
