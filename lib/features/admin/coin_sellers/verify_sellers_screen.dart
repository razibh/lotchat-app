...
class VerifySellersScreen extends StatefulWidget {
  const VerifySellersScreen({Key? key}) : super(key: key);
...
class _VerifySellersScreenState extends State<VerifySellersScreen> {
  List<PendingSeller> _sellers = <PendingSeller>[];
  ...
  void _loadSellers() {
    _sellers = <PendingSeller>[
      ...
      PendingSeller(
        ...
        flag: '🇮🇳',
        discountRate: 12,
        documents: <String>['NID', 'License', 'Bank'],
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final PendingSeller seller = _sellers[index];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <>[
          ...
          Row(
            children: <>[
              Icon(Icons.percent, color: Colors.white70, size: 14),
              const SizedBox(width: 4),
          ...
          Wrap(
            spacing: 8,
            children: seller.documents.map((String doc) {
              return Container(
