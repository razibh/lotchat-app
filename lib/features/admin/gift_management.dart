...
class _GiftManagementState extends State<GiftManagement>
  ...
  Future<void> _loadGifts() async {
    await runWithLoading(() async {
      try {
        _gifts = GiftModel.getMockGifts(); // getGifts() এর পরিবর্তে getMockGifts()
      } catch (e) {
  ...
  Future<void> _addGift() async {
    ...
    showDialog(
      context: context,
      builder: (BuildContext context) => const AddGiftDialog(),
    ).then((value) {
      if (value == true) {
        _loadGifts();
      }
  ...
  Future<void> _editGift(GiftModel gift) async {
    ...
    showDialog(
      context: context,
      builder: (BuildContext context) => EditGiftDialog(gift: gift),
    ).then((value) {
      if (value == true) {
        _loadGifts();
      }
...
class EditGiftDialog extends StatefulWidget {
  ...
  const EditGiftDialog({required this.gift, super.key});
