...
class PermissionUtils {
  ...
  static Future<bool> requestCameraPermission() async {
    final status = await _permissionService.requestPermission(PermissionType.camera);
    return status.isGranted;
  }

  static Future<bool> checkCameraPermission() async {
    final status = await _permissionService.checkPermission(PermissionType.camera);
    return status.isGranted;
  }

  // Microphone permission
  static Future<bool> requestMicrophonePermission() async {
    final status = await _permissionService.requestPermission(PermissionType.microphone);
    return status.isGranted;
  }

  static Future<bool> checkMicrophonePermission() async {
    final status = await _permissionService.checkPermission(PermissionType.microphone);
    return status.isGranted;
  }

  // Storage permission
  static Future<bool> requestStoragePermission() async {
    final status = await _permissionService.requestPermission(PermissionType.storage);
    return status.isGranted;
  }

  static Future<bool> checkStoragePermission() async {
    final status = await _permissionService.checkPermission(PermissionType.storage);
    return status.isGranted;
  }

  // Location permission
  static Future<bool> requestLocationPermission() async {
    final status = await _permissionService.requestPermission(PermissionType.location);
    return status.isGranted;
  }

  static Future<bool> checkLocationPermission() async {
    final status = await _permissionService.checkPermission(PermissionType.location);
    return status.isGranted;
  }

  // Contacts permission
  static Future<bool> requestContactsPermission() async {
    final status = await _permissionService.requestPermission(PermissionType.contacts);
    return status.isGranted;
  }

  static Future<bool> checkContactsPermission() async {
    final status = await _permissionService.checkPermission(PermissionType.contacts);
    return status.isGranted;
  }

  // Notifications permission
  static Future<bool> requestNotificationsPermission() async {
    final status = await _permissionService.requestPermission(PermissionType.notifications);
    return status.isGranted;
  }

  static Future<bool> checkNotificationsPermission() async {
    final status = await _permissionService.checkPermission(PermissionType.notifications);
    return status.isGranted;
  }

  // Photos permission (iOS specific)
  static Future<bool> requestPhotosPermission() async {
    final status = await _permissionService.requestPermission(PermissionType.photos);
    return status.isGranted;
  }

  static Future<bool> checkPhotosPermission() async {
    final status = await _permissionService.checkPermission(PermissionType.photos);
    return status.isGranted;
  }
  ...
  static Future<Map<PermissionType, bool>> requestPermissions(
    ...
    final statuses = await _permissionService.requestPermissions(types);
    return statuses.map((PermissionType key, Object? value) => MapEntry(key, value.isGranted));
  }
