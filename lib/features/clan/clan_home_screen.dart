          ...
          ? FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (BuildContext context) => const CreateClanScreen(),
                  ),
                ).then((_) => _loadData());
              },
              backgroundColor: Colors.deepPurple,
          ...
          ClanCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (BuildContext context) => ClanDetailScreen(clan: _myClan),
                ),
              ).then((_) => _loadData());
            },
          ),
                ...
                child: ClanCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (BuildContext context) => ClanDetailScreen(clan: clan),
                      ),
                    ).then((_) => _loadData());
                  },
                ),
