...
class ClanWar {
  ...
  ClanWar({
    ...
    required this.startTime, required this.endTime, required this.ourScore, required this.opponentScore, required this.status, required this.prize, this.opponentEmblem,
  });
  final String id;
