...
class FollowingScreen extends StatefulWidget {
  ...
  const FollowingScreen({required this.userId, super.key});
  final String userId;
  ...
  void _filterFollowing(String query) {
    setState(() {
      ...
      if (query.isEmpty) {
        ...
        _filteredFollowing = _following.where((UserModel f) {
          ...
          : _filteredFollowing.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    final UserModel user = _filteredFollowing[index];
                    return ProfileFriendTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (BuildContext context) => ProfileScreen(userId: user.uid),
                          ),
                        );
                      },
                    );
