...
class _ProfileScreenState extends State<ProfileScreen> 
  ...
  void _navigateToBadges(ProfileModel profile) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BadgesScreen(userId: profile.userId),
      ),
    );
  }
  ...
  void _navigateToFrames(ProfileModel profile) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => FramesScreen(userId: profile.userId),
      ),
    );
  }
  ...
  void _navigateToAchievements(ProfileModel profile) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AchievementsScreen(userId: profile.userId),
      ),
    );
  }
