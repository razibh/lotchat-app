...
class CountryProvider extends ChangeNotifier {
  ...
  Future<void> loadSavedCountry() async {
    try {
      ...
      final countryId = prefs.getString(AppConstants.prefCountry);
  ...
  List<Country> getNearbyCountries() {
    ...
    final var nearbyMap = <String, List<String>><String, List<String>>{
    ...
    final List<String> nearbyIds = nearbyMap[_selectedCountry!.id] ?? <String>[];
    return _supportedCountries
