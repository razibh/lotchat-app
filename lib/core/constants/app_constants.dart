class AppConstants {
  // App Information
  static const String appName = 'LotChat App';
  ...
  static const int socketReconnectDelay = 3000; // milliseconds
  ...
  static const int maxPkBet = 50000;
  static const int pkRoundDuration = 60; // seconds
  ...
  static const int masterThreshold = 100000;
  static const int legendThreshold = 200000;
  ...
  static const String notificationChannelId = 'lotchat_channel';
  static const String notificationChannelName = 'LotChat Notifications';
  static const String notificationChannelDescription = 'Notifications for LotChat app';

  // Deep Links
  static const String deepLinkHost = 'lotchat.page.link';
  static const String deepLinkPrefix = 'https://lotchat.page.link';
  ...
  static const String youtubeUrl = 'https://youtube.com/@lotchat';
  static const String tiktokUrl = 'https://tiktok.com/@lotchat';

  // Support
  static const String supportEmail = 'support@lotchat.com';
  static const String supportWebsite = 'https://lotchat.com';
  ...
  static const String faqUrl = 'https://lotchat.com/faq';
  static const String aboutUrl = 'https://lotchat.com/about';
  ...
  static const String errorMicrophone = 'Microphone permission denied.';
  static const String errorStorage = 'Storage permission denied.';
  ...
  static const String successReport = 'Report submitted successfully!';
  ...
  static const String dateFormatMessage = 'HH:mm';
  static const String dateFormatMessageFull = 'dd MMM, HH:mm';
  ...
  // Button Sizes
  static const double buttonHeightXSmall = 28;
  ...
  static const double buttonHeightXXLarge = 64;
  ...
  static const double avatarXXLarge = 100;

  // Card Dimensions
  static const double cardWidthSmall = 200;
  static const double cardWidthNormal = 280;
  static const double cardWidthLarge = 350;
  static const double cardHeightSmall = 150;
  static const double cardHeightNormal = 200;
  static const double cardHeightLarge = 250;

  // Default Values
  static const int defaultDebounceMilliseconds = 500;
  static const int defaultThrottleMilliseconds = 1000;
...
class CacheKeys {
  ...
  static const String recentCalls = 'recent_calls';
}
...
class AnalyticsEvents {
  ...
  static const String pkWin = 'pk_win';
  static const String pkLose = 'pk_lose';
}