...
class GroupChatScreen extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('groupName', groupName));
  }
}
...
class ChatInfoScreen extends StatelessWidget {
  ...
  const ChatInfoScreen({
    required this.chatId, required this.chatType, super.key,
  });
  final String chatId;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('chatType', chatType));
  }
}
...
class SellerPackagesScreen extends StatelessWidget {
  const SellerPackagesScreen({super.key});
