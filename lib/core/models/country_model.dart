class CountryModel {
  ...
  CountryModel({
    ...
    required this.flag,
    required this.continent, required this.currency, required this.currencySymbol, required this.timezone, required this.languages, required this.population, required this.area, this.flagSvg,
    this.isActive = true,
  });
...
class RegionModel {
  ...
  RegionModel({
    ...
    required this.latitude, required this.longitude, required this.population, this.stateCode,
  });
