...
class CallModel {
  ...
  CallModel({
    ...
    required this.receiverId, required this.receiverName, required this.callType, required this.direction, required this.status, required this.startTime, required this.duration, this.callerAvatar,
    this.receiverAvatar,
    this.endTime,
    this.roomId,
  ...
  factory CallModel.fromJson(Map<String, dynamic> json) {
    return CallModel(
      ...
      participants: List<String>.from(json['participants'] ?? <dynamic>[]),
...
class CallLog {
  ...
  CallLog({
    ...
    required this.callType, required this.direction, required this.status, required this.timestamp, required this.duration, this.contactAvatar,
  });
