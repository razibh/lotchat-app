class UserModel {
  ...
  UserModel({
    ...
    required this.email,
    required this.phone,
    required this.country, required this.region, required this.lastActive, this.photoURL,
    this.bio,
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) => UserModel(
        ...
        friends: List<String>.from(json['friends'] ?? <dynamic>[]),
        followers: List<String>.from(json['followers'] ?? <dynamic>[]),
        following: List<String>.from(json['following'] ?? <dynamic>[]),
