...
class ReferralService {
  ...
  Future<Map<String, dynamic>> getReferralStats() async {
    ...
    try {
      ...
      final monthReferrals = await _firestore
          .collection('referrals')
          .where('referrerId', isEqualTo: user.uid)
      ...
      final weekReferrals = await _firestore
          .collection('referrals')
          .where('referrerId', isEqualTo: user.uid)
      ...
      // Calculate earnings
      final totalEarnings = referralsSnapshot.docs.length * 1000;
    ...
    return _firestore
        ...
        .asyncMap((snapshot) async {
          ...
          for (final doc in snapshot.docs) {
            final data = doc.data();
            final referredUser = await _firestore
                .collection('users')
                .doc(data['referredId'])
                .get();
