...
class MessageModel {
  ...
  MessageModel({
    ...
    required this.type, required this.status, required this.content, required this.timestamp, this.senderAvatar,
    this.mediaUrl,
    this.thumbnailUrl,
    this.fileName,
    this.fileSize,
  ...
  factory MessageModel.fromJson(Map<String, dynamic> json) {
    return MessageModel(
      ...
      deletedAt: json['deletedAt'] != null 
          ...
          : null,
      readBy: List<String>.from(json['readBy'] ?? <dynamic>[]),
      reactions: (json['reactions'] as List?)
          ?.map((r) => MessageReaction.fromJson(r))
          .toList() ?? <MessageReaction>[],
