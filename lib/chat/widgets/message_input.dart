...
class MessageInput extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ObjectFlagProperty<Function(String)>.has('onSend', onSend));
    properties.add(ObjectFlagProperty<Function(File)?>.has('onAttachment', onAttachment));
    properties.add(ObjectFlagProperty<Function(String)?>.has('onTyping', onTyping));
